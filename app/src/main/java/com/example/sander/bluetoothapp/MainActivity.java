package com.example.sander.bluetoothapp;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener
{
    ...
    public com.example.sander.bluetoothapp.DeviceListAdapter mDeviceListAdapter;
    ...
    private BroadcastReceiver mBroadcastReceiver3 = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(BluetoothDevice.ACTION_FOUND)){
                ...
                mDeviceListAdapter = new com.example.sander.bluetoothapp.DeviceListAdapter(context, R.layout.device_adapter_view, mBTDevices);
                lvNewDevices.setAdapter(mDeviceListAdapter);
            }
        }
    };

    //broadcastreceiver that detects bond state changes (Pairing status changes)
